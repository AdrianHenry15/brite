...
import xmas from "../../../public/assets/imgs/garland.png";

const LightingPromo = () => {
    return (
        <div>
            <Image className="object-cover lg:h-32 md:h-10" src={xmas} alt="xmas" />
            <div className="flex flex-col p-6 py-6 w-full lg:px-48 lg:py-16">
                ...
                <div className="flex">
                    <Image
                        src={Pic}
                        alt="pic"
                        className="hidden w-64 lg:flex h-64 self-center mr-24"
                    />
                    {/* TEXT CONTAINER */}
